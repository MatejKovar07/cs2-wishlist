"""
Django settings for muj_projekt project.
...
SECRET_KEY = 'django-insecure-8ecv1^^lmk*vr481wtr6suipkjco)3ve53q#yufw9a7-roqz0s'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'blabla',      # Jméno tvé databáze v phpMyAdmin
